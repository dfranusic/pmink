...
namespace antlr {
	...
	void process_config_block(pANTLR3_BASE_TREE tmp_ast, config::ConfigItem* tmp_cfg, bool is_definition);
	void cli_process_pattern_block(pANTLR3_BASE_TREE tmp_ast, cli::CLIService* cli_service);
	void cfg_process_pattern_block(pANTLR3_BASE_TREE tmp_ast, config::Config* cfg);
	void cli_process_config(pANTLR3_BASE_TREE p_ast_tree, cli::CLIItem* cli_tree_res);
	void process_config_def(pANTLR3_BASE_TREE p_ast_tree, config::ConfigItem* config_tree_res);
	void process_config(pANTLR3_BASE_TREE p_ast_tree, config::ConfigItem* config_tree_res);
	void cli_process_patterns(pANTLR3_BASE_TREE p_ast_tree, cli::CLIService* cli_service);
	void config_process_patterns(pANTLR3_BASE_TREE p_ast_tree, config::Config* cfg);
	void build_cli_tree(pANTLR3_BASE_TREE p_ast_tree, cli::CLIItem* cli_tree);
	void build_config_def_tree(pANTLR3_BASE_TREE p_ast_tree, config::ConfigItem* config_tree, bool is_definition);
	void build_pattern_tree(pANTLR3_BASE_TREE p_ast_tree, config::Config* cli_service);
