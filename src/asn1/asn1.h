...
namespace asn1 {
	...
	public:
		...
		//void change_linked_data(uint64_t _session_id, unsigned char* _data, unsigned int _data_length, bool _shallow);
	...
	void mem_transfer_deep(ASN1Node* root_node, unsigned char* dest_buffer, int dest_buffer_pos);
	...
	int _decode(unsigned char* data, unsigned int data_length, ASN1Node* root_node, ASN1Pool* _asn1_pool, unsigned int* used_nc);

	// helper decode method, used ONLY internally
	int _decode(unsigned char* data, unsigned int data_length, ASN1Node* root_node, ASN1Node* root_defintion_node, ASN1Pool* _asn1_pool, uint64_t* _session_id, unsigned int* used_nc);
	...
	int encode(unsigned char* buffer, int buffer_length, ASN1Node* root_node, uint64_t _session_id, bool mem_switch);
	...
	int generalized_time(time_t ts, unsigned int msec, unsigned char* output, bool local_time = true);
	...
	uint32_t prepare_int(uint32_t val, unsigned int* req_bytes, int req_b_override = -1);
