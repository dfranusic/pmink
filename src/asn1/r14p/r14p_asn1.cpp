...
//SmsStatusType
asn1::SmsStatusType::SmsStatusType(){
	strcpy(node_type_name, "SmsStatusType");
...
//SmsHubCommandId
asn1::SmsHubCommandId::SmsHubCommandId(){
	strcpy(node_type_name, "SmsHubCommandId");
...
//R14PMessage
asn1::R14PMessage::R14PMessage(){
	strcpy(node_type_name, "R14PMessage");
	// header
	_header = NULL;
	_header = new Header();
...
asn1::ASN1Node* asn1::R14PMessage::create_node(unsigned int _index){
	switch(_index){
		case 1:
		{
			_body = new Body();
...
void asn1::R14PMessage::set_body(){
